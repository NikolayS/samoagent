...
export function SiteFooter() {
  const links = [["get started", "/auth"], ["docs", "https://github.com/NikolayS/samograph"], ["cli on github", "https://github.com/NikolayS/samograph"], ["dictionaries", "#dictionaries"], ["status", "#status"], ["privacy", "#privacy"], ["hello@samograph.dev", "mailto:hello@samograph.dev"]] as const;
